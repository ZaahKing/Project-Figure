@guest
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="/Account/About/">{{__('label.about')}}</a></li>
        <li class="nav-item"><a class="nav-link" href="/Account/Contacts/">{{__('label.contacts')}}</a></li>
    </ul>
@else
    <ul class="navbar-nav">
        <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        {{ Auth::user()->name }}</a>
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="#">{{__('label.about')}}</a>
                <a class="dropdown-item" href="#">{{__('label.contacts')}}</a>
